...
```
    ...
    d:\pywork\ollama\basic5_torch\prj\Lib\site-packages\huggingface_hub\file_download.py:139: UserWarning: `huggingface_hub` cache-system uses symlinks by default to efficiently store duplicated files but your machine does not support them in C:\Users\linchao\.cache\huggingface\hub\models--hfl--rbt3. Caching files will still work but in a degraded version that might require more space on your disk. This warning can be disabled by setting the `HF_HUB_DISABLE_SYMLINKS_WARNING` environment variable. For more details, see https://huggingface.co/docs/huggingface_hub/how-to-cache#limitations.
...
```python
model = AutoModel.from_pretrained(location) #"../../pretrain/rbt3"
```
    ...
    BaseModelOutputWithPoolingAndCrossAttentions(last_hidden_state=tensor([[[ 0.6804,  0.6664,  0.7170,  ..., -0.4102,  0.7839, -0.0262],
           ...
           grad_fn=<NativeLayerNormBackward0>), pooler_output=tensor([[-1.2646e-01, -9.8619e-01, -1.0000e+00, -9.8325e-01,  8.0238e-01,
             ...
             -9.9153e-01,  4.4752e-02, -9.8731e-01, -9.9942e-01, -9.9982e-01,
              ...
              4.5074e-03,  9.9998e-01,  9.9467e-01,  4.9727e-03, -9.0707e-01,
             ...
             -5.1678e-01,  5.2056e-02,  5.4614e-02, -9.9816e-01,  9.9328e-01,
              1.2798e-04, -1.3744e-01,  1.0000e+00,  9.9984e-01, -3.4417e-01,
             ...
             -1.5316e-01,  9.0941e-02, -9.5427e-02, -1.0000e+00, -9.9974e-01,
             -9.9999e-01,  9.5742e-01, -3.5169e-01,  9.9779e-01, -9.9894e-01,
              9.9997e-01, -9.9997e-01,  9.9997e-01,  9.9414e-01, -2.7013e-01,
             -9.7769e-01, -1.1832e-01, -9.9976e-01, -4.3268e-02,  2.7015e-02,
             ...
             -7.4189e-02,  8.3064e-01, -8.6326e-02,  9.9989e-01,  1.6120e-01,
              8.7417e-01,  4.2876e-03,  9.9993e-01, -8.4737e-01, -9.9999e-01,
             ...
             -4.9746e-03, -2.4950e-01,  2.0312e-01, -2.2919e-01,  9.9857e-01,
             ...
             -2.2660e-02,  7.8255e-01, -2.6024e-02,  9.9999e-01, -1.2445e-02,
             ...
             -9.9999e-01, -9.9998e-01,  9.9993e-01,  1.0225e-01, -5.4213e-04,
             ...
             -4.7267e-01, -8.6810e-01, -1.0000e+00, -9.9985e-01,  9.9819e-01,
              ...
              9.7417e-01,  3.1610e-01, -9.9945e-01, -9.9936e-01, -3.3199e-03,
              7.0083e-02,  1.5903e-01,  9.8475e-03, -5.9952e-02,  9.9992e-01,
             ...
             -9.9825e-01, -9.9979e-01,  1.5165e-02, -9.9095e-01, -9.9897e-01,
