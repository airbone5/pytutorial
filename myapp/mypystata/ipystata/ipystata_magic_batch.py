...
class iPyStataMagic(Magics):
    ...
    def stata(self, line, cell, local_ns=None):
        ...
        # mynote replace pdf->png
        #graph_out = os.path.join(iPyStata.tornado_dir, 'temp_graph.pdf')
        graph_out = os.path.join(iPyStata.tornado_dir, 'temp_graph.png')
        ...
        with open(code_file, "w") as myfile:
            ...
            if args.graph:
                ...
                print('graph export "%s", replace' % graph_out + "\n")
        ...
        if not args.noprint:
            if args.graph:
                ...
                if re.search('could not find Graph window', out, flags=re.I) is None:
                    #mynote  -1 +1   
                    #return IFrame('./temp_graph.png', width=700, height=400)
